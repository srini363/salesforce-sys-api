{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "Unable to create/update fields: employee_Id__c. Please check the security settings of this field and verify that it is read/write for your profile or permission set. INVALID_FIELD_FOR_INSERT_UPDATE",
        "cause": null,
        "message": "Unable to create/update fields: employee_Id__c. Please check the security settings of this field and verify that it is read/write for your profile or permission set. INVALID_FIELD_FOR_INSERT_UPDATE",
        "stackTrace": [
          {
      ...
      "message": "Unable to create/update fields: employee_Id__c. Please check the security settings of this field and verify that it is read/write for your profile or permission set.",
      "payload": {
        "created": true,
        "success": false,
        "id": null,
